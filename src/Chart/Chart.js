...
const Chart = () => {
  const [activeTab, setActiveTab] = useState("Open Interest");

  return (
    <div className="chart-container">
      {/* Tabs */}
      <div className="tab-group">
        {["Funding Rate", "Open Interest", "Trading view"].map((tab) => (
          <button
            key={tab}
      ...
      <div className="exchange-filters">
        <span className="exchange-tag">
          Binance <IoMdClose className="close-btn" />
        </span>
        <span className="exchange-tag">
          Bybit <IoMdClose className="close-btn" />
        </span>
      </div>
